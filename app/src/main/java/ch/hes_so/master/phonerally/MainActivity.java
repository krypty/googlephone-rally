...
//
//        // if the user has already select a bt device in the past, we skip the bt device choosing step.
//        String btAddress = prefs.getString(getApplicationContext().getString(R.string.pref_bt_device_address), null);
//        if (btAddress != null && !btAddress.isEmpty()) {
////            startNextActivity();
//            Toast.makeText(MainActivity.this, "StartNextActivity", Toast.LENGTH_LONG).show();
//        }
        ...
        mEtOutText = (EditText) findViewById(R.id.etOutText);
    ...
    private void setupChat() {
        ...
        mLvChat.setAdapter(mConversationArrayAdapter);

        // Initialize the compose field with a listener for the return key
        mEtOutText.setOnEditorActionListener(mWriteListener);

        // Initialize the send button with a listener that for click events
        mBtnSend.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                // Send a message using content of the edit text widget
                TextView textView = (TextView) MainActivity.this.findViewById(R.id.etOutText);
